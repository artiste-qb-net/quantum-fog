from q_ckt_processing.SEO_writer import *


class FouSEO_writer(SEO_writer):
    """
    This class writes English and Picture files for the exact compilation,
    discovered by Coppersmith, of the Discrete Fourier Transform. We follow
    the conventions of quant-ph 0407215, "QC Paulinesia" by R.R. Tucci.
    ...
    """
    def __init__(
            self, file_prefix, emb, do_write, **kwargs):
        """
        Constructor
...
if __name__ == "__main__":
    ...
    for zf in [True, False]:
        wr = FouSEO_writer('test', emb, do_write=True,
                           zero_bit_first=zf)
